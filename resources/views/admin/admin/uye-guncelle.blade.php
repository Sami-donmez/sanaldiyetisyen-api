    ...
    <form class="form-horizontal" method="post" action="{{url()->current()}}">
        ...
        <!-- Form Name -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input id="textinput" name="ad" type="text" value="{{$data->name}}" class="form-control input-md" required="">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input id="textinput" name="email" type="text" value="{{$data->mail}}" class="form-control input-md" required="">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group hatdiv" style="">
                ...
                <div class="col-md-8">
                    <select id="selectbasic5" name="yetki" class="form-control">
                        <option value="user" {{$data->role=="user"?"checked":""}}>ögrenci</option>
                        <option value="admin" {{$data->role=="admin"?"checked":""}}>Yetkili</option>
                    </select>
                </div>
            </div>
            <!-- Button -->
